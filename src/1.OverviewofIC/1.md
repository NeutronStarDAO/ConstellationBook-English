...
The **nodes** in each **data centre** are **virtualized into many replicas** **through the node software IC-OS**, and then some replicas are randomly selected to form a **subnet** .
